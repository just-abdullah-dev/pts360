...
export default function HODGoalView() {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 text-sm">
            Manage your team's goals and individual tasks
          </p>
        </div>
      </div>
      ...
      >
        <div className="flex justify-between items-center">
          <TabsList className="grid w-full grid-cols-2 max-w-md">
            <TabsTrigger value="team-goals">Team's Goals</TabsTrigger>
            <TabsTrigger value="my-jobs">My Jobs & Tasks</TabsTrigger>
          </TabsList>
        ...
        {/* Team's Goals Tab */}
        <TabsContent value="team-goals" className="space-y-2">
        ...
        {/* My Jobs & Tasks Tab */}
        <TabsContent value="my-jobs" className="space-y-2">
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 text-center">
            <p className="text-gray-500 dark:text-gray-300">
              My Jobs & Tasks view will be implemented here with similar
              structure to Team's Goals but filtered for current user.
            </p>
          </div>
        </TabsContent>
      </Tabs>
